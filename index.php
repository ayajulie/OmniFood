...
<head>
  ...
  <meta name="theme-color" content="#d49090">
...
<body>
    ...
    <div class="row  js--wp-1">
      ...
      <div class="col span-1-of-4 box">
        ...
        <p>You're only twenty minutes away from your delicious and super healthy meals delivered right to your home. We
          work
          with the best chefs in each town to ensure that you're 100% happy..</p>
      </div>
      ...
      <div class="col span-1-of-4 box">
        ...
        <p>We don't limit your creativity, which means you can order whatever you feel like. You can also choose from
          our
          menu containing over 100 delicious meals. It's up to you!</p>
      </div>
    </div>
  </section>
  ...
  <section class="section-steps" id="work">
    <div class="row">
      <h2>How it works &mdash; Simple as 1, 2, 4</h2>
    </div>
    <div class="row">
      ...
      <div class="col span-1-of-2 steps-box">
        ...
        <a href="#" class="btn-app"><img src="/resources/img/download-app.svg" alt=""></a>
        <a href="#" class="btn-app"><img src="/resources/img/download-app-android.png" alt=""></a>
      </div>
    </div>
  </section>
  <section class="section-cities" id="cities">
    ...
    <div class="row js--wp-3">
      <div class=" col span-1-of-4 box ">
        <img src="/resources//img/lisbon-3.jpg" alt="Photo of the city of Lisbon">
        <h3>Lisbon</h3>
      ...
      <div class=" col span-1-of-4 box">
        <img src="/resources//img/san-francisco.jpg" alt="Photo of the city of San Francisco">
        <h3>San Francisco</h3>
        <div class="city-feature">
          <i class="ion-ios-person icon-small"></i>
          3700+ happy eaters
      ...
      <div class=" col span-1-of-4 box">
        <img src="/resources//img/berlin.jpg" alt="Photo of the city of Berlin">
        <h3>Berlin</h3>
        <div class="city-feature">
          <i class="ion-ios-person icon-small"></i>
          2300+ happy eaters
      ...
      <div class=" col span-1-of-4 box">
        <img src="/resources//img/london.jpg" alt="Photo of the city of London">
        <h3>London</h3>
        <div class="city-feature">
          <i class="ion-ios-person icon-small"></i>
          2300+ happy eaters
    ...
    <div class="row">
      <div class="col span-1-of-3">
        <blockquote>
          ...
          <cite><img src="resources/img/customer-1.jpg" alt="picture of a male customer">Alberto Duncan</cite>
        </blockquote>
      </div>
      <div class="col span-1-of-3">
        <blockquote>
          ...
          <cite><img src="resources/img/customer-2.jpg" alt="picture of a female customer">Joana Silva</cite>
        </blockquote>
      </div>
      <div class="col span-1-of-3">
        <blockquote>
          ...
          <cite><img src="resources/img/customer-3.jpg" alt="picture of a male customer">Milton Chapman</cite>
        </blockquote>
      </div>
    </div>
  </section>
  ...
  <footer>
    ...
    <div class="row">
      ...
      <p>
        Copyright &copy;2021 - Ayko. All Rights Reserved
      </p>
    </div>
  </footer>
